...
function show() {
    let table = '<table class = table><tr><th>№</th><th>Nomi</th><th>Kuni</th><th>Vaqti</th><th>Muhimlik</th><th></th></tr>';
    let result = document.getElementById('js-qaydlar');
...
function showCalendar() {
    ...
    calendar('#js-kalendar', globalYear, globalMonth);
